...
<html>
	...
	<section class="oja">
		...
		<form method="POST" action="changeprioridadnoti.php?ant=noti">
			<div class="priotabla">
			<table id="tabla" class="newtabla">
				...
				<?php
					...
					$sql1 = "SELECT id_noticia,titulo,portada,prioridad,fecha FROM noticia ORDER BY prioridad DESC";
					...
					while($noticia = mysqli_fetch_array($texto2)){
						...
						echo "<tr id='".$noticia['0']."' data-prioridad='".$noticia['3']."'><td id='img'><img src='".$noticia['2']."' class='chiquito1' /></td><td id='tex'><p>".$daa."</p></td><td id='tex'><p>".$noticia['1']."</p></td><td id='tex'><input id='".$noticia[0]."".$noticia[0]."' type='hidden'  name='amodificar[]'/></td></tr>";
					}
				?>
			</table>
			</div>
