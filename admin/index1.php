		...
		<?php
					...
					if(count($texto2)!=0){
						...
						while($noticiadestacada = mysqli_fetch_array($texto2)){
							...
							if($x==1){
								echo "<div class='contenedor-img7 ejemplo-3' id='chico'><img src='".$noticiadestacada['3']."' /><div class='mascara7'><p class='date'>".$daa."</p><h2>".$titulo."</h2><p class='date'>".$sinopsis."</p><a href='display.php?noticia=".$noticiadestacada['0']."' class='link'>Leer Mas</a><div class='icon'><a href='modificarnoti.php?noticia=".$noticiadestacada[0]."'><i id='edi' class='fa fa-pencil'></i></a><a href='quickdeletenoti?noticia=".$noticiadestacada['0']."'><i id='bas' class='fa fa-trash'></i></a></div></div></div>";
								
							}elseif($x==2){
								echo "<div class='contenedor-img8 ejemplo-3' id='chico'><img src='".$noticiadestacada['3']."' /><div class='mascara8'><p class='date'>".$daa."</p><h2 class='nose3'>".$titulo."</h2><p>".$sinopsis."</p><a href='display.php?noticia=".$noticiadestacada['0']."' class='link'>Leer Mas</a><div class='icon'><a href='modificarnoti.php?noticia=".$noticiadestacada[0]."'><i id='edi' class='fa fa-pencil'></i></a><a href='quickdeletenoti?noticia=".$noticiadestacada['0']."'><i id='bas' class='fa fa-trash'></i></a></div></div></div>";
								
							}elseif($x==3){
								echo "<div class='contenedor-img9 ejemplo-3' id='chico'><img src='".$noticiadestacada['3']."' /><div class='mascara9'><p class='date'>".$daa."</p><h2>".$titulo."</h2><p>".$sinopsis."</p><a href='display.php?noticia=".$noticiadestacada['0']."' class='link'>Leer Mas</a><div class='icon'><a href='modificarnoti.php?noticia=".$noticiadestacada[0]."'><i id='edi' class='fa fa-pencil'></i></a><a href='quickdeletenoti?noticia=".$noticiadestacada['0']."'><i id='bas' class='fa fa-trash'></i></a></div></div></div>";
