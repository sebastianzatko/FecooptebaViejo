		...
		<?php
							...
							if(count($texto)!=0){
								...
								while($asociado = mysqli_fetch_array($texto)){
										...
										echo "<div class='cajaasociados'><img class='imgasociados' src='".$asociado['2']."'><div class='overlay'><div class='text'>".cortar($asociado['1'],30)."</br></br><a href='verasociado.php?asociado=".$asociado['0']."' class='link'>Leer Mas</a><div class='icon'><a href='modificarasoc.php?asociado=".$asociado['0']."&cate=1'><i id='edi' class='fa fa-pencil'></i></a><a href='quickdeteasoc.php?asociado=".$asociado['0']."'><i id='bas' class='fa fa-trash'></i></a></div></div></div></div>";
