...
<html>
	...
	<?php if (login_check($mysqli) == true) : ?>
		...
		<?php
			$id=$_GET["comision"];
			$query="SELECT content,nombrecomision FROM comision WHERE id_comision='$id'";
		...
		<form action="updatecomision.php?comision=<?php echo $id; ?>" method="POST">
			<h2 style="margin-top:5%;margin-bottom:2%;">Titulo de Comision </h2>
			<input type="text" name="titulocomision" maxlength='100' class="ingr" style="margin-bottom:2%;" required value="<?php echo $fila[1]; ?>" />
			<textarea name="contentcomision" id="summernote" class="ingr" style="margin-bottom:2%;" required ><?php echo $fila[0]; ?></textarea>
