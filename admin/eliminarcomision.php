...
<html>
	...
	<section class="oja">
		...
		<form action="deletecomision.php" method="POST">
			<div class="divtabla1" style="margin-bottom: 10%; margin-top: 7%;">
			
				<table class="tablaatr" >
					<tbody id='list'>
						<tr class="atr">
							<th>Titulo de comision</th>
							<th>Eliminar</th>
						</tr>
							<?php
								require 'conection.php';
								$sql1 = "SELECT id_comision,nombrecomision FROM comision";
								$texto2=mysqli_query($con,$sql1) or die(mysqli_error($con));
								while($comision = mysqli_fetch_array($texto2)){
									echo "<tr><td class='tituloatr'>".$comision[1]."</td><td><input name='ids[]' type='checkbox' value='".$comision['0']."' class='checkatr'</td></tr>";
								}
