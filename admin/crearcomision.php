...
<html>
	...
	<?php if (login_check($mysqli) == true) : ?>
		...
		<form action="createcomision.php" method="POST">
			<h2 style="margin-top:5%;">Titulo de Comision </h2>
			<input type="text" name="titulocomision" class="ingr" maxlength='100' required />
			<textarea id="summernote" name="contentcomision" class="ingr" required ></textarea>
