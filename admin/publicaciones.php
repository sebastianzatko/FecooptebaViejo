...
<html>
	...
	<?php if (login_check($mysqli) == true) : ?>
		...
		<form action="cambiarpublicacion.php" method="POST" enctype="multipart/form-data">
		
			<h2 style="margin-top:5%;margin-bottom:2%;">Nueva Publicacion</h2>
			<textarea name="texto" class="textfijaedicion" id="summernote" class="ingr" required></textarea>
