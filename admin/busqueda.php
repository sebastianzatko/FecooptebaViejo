...
<html>
	...
	<body>
		...
		<section class="buscar">
				<h2 class="encabezado"><img src="icons/noticiasazul.png" class="iconitos2"/>Noticias</h2>
		...
		<section class="notise">
				<?php
					...
					if(count($texto2)==0){
						echo "<section class='error404'><img src='images/202381_poster_.png' alt='Logotipo de HTML5' class='errorimg' ><div CLASS='errorcaja'><h2>Lo sentimos</h2><p>No hubo resultados</p></div></section> ";
					}
					$x=rand(1, 3);
