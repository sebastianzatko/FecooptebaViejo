		...
		<div class="divtabla1" style="margin-bottom: 10%; margin-top: 7%;background: #f5f5f5;padding: 3%;" id="der">
			...
			<center><h2 class="h2atr">Documentos</h2></center>
				<tr> 
					...
					<th class="titulodocmoc">Nombre</th>
					<th class="titulodocmoc">Modificar</th>
				</tr>
				<?php
					require 'conection.php';
					$consulta="SELECT id_documento,nombre FROM documento WHERE categoria=1";
					$obtener=mysqli_query($con,$consulta) or die(mysqli_error($con));
					while($documento = mysqli_fetch_array($obtener)){
						echo "<tr><td class='documod'><p>".$documento['1']."</p></td><td class='docuselec'><a href='modificardoc.php?doc=".$documento['0']."'>Seleccionar</a></td></tr>";
					}
				?>
			</table>
				</div>
			...
			<table class="tabla4">
			<center><h2 class="h2atr">Legislaciones</h2></center>
				<tr>
				...
				<?php
					$consulta1="SELECT id_documento,nombre FROM documento WHERE categoria=2";
					$obtener1=mysqli_query($con,$consulta1) or die(mysqli_error($con));
					while($documentop = mysqli_fetch_array($obtener1)){
						echo "<tr><td class='documod'><p>".$documentop['1']."</p></td><td class='docuselec'><a href='modificardoc.php?doc=".$documentop['0']."'>Seleccionar</a></td></tr>";
					}
				?>
			</table>
		</div>
