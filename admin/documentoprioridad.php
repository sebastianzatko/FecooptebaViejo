...
<html>
	<head>
		<title>Relevancia Documentos</title>
	...
	<section class="oja">
		...
		<form action="changeprioridaddoc.php?ant=doc" method="POST">
            <div class="priotabla">
			<table id="tabla" class="newtabla">
				...
				<?php
					...
					$sql1 = "SELECT id_documento,nombre,rutadoc,prioridad FROM documento WHERE categoria=1 ORDER BY prioridad DESC";
