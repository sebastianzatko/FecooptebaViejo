...
<html>
	<head>
		<title>Prioridad Noticia Carrusel</title>
	...
	<section class="oja">
		...
		<form action="changeprioridadnoti.php?ant=sli" method="POST">
			<div class='priotabla'>
			<table id="tabla" class="newtabla">
				...
				<?php
					...
					$sql1 = "SELECT id_noticia,titulo,portada,prioridad,fecha FROM noticia WHERE slider=1 ORDER BY prioridad DESC";
