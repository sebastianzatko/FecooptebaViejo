 ...
 */
define("HOST", "sql146.main-hosting.eu."); 			// The host you want to connect to. 
define("USER", "u519469703_admin"); 			// The database username. 
define("PASSWORD", "jPGrKf8EXClW"); 	// The database password. 
define("DATABASE", "u519469703_fecop");             // The database name.
