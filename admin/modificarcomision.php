	...
	<?php if (login_check($mysqli) == true) : ?>
		...
		<div class="cubalibre" >
			<table     style='width: 100%;' >
				<tbody id='list'>
					<tr class="atr">
						<th class="atr">Nombre de Comision</th>
					...
					<?php
						...
						while($comision = mysqli_fetch_array($texto2)){
							echo "<tr><td class='tituloatr'>".$comision[1]."</td><td class='modificaratr'><a href='modificarcomi.php?comision=".$comision['0']."'>Seleccionar</a></td></tr>";
						}
