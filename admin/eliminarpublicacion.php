...
<html>
	...
	<section class="oja">
		...
		<form method="POST" action="deletepublicacion.php">
			...
			<table class="tablaatr" >
					<tbody id='list'>
						...
						<?php
							...
							$sql1 = "SELECT id_publicacion,content FROM publicaciones";
							$texto2=mysqli_query($con,$sql1) or die(mysqli_error($con));
							while($publicacion = mysqli_fetch_array($texto2)){
								echo "<tr><td class='tituloatr'>".$publicacion[1]."</td><td><input name='ids[]' type='checkbox' value='".$publicacion['0']."' class='checkatr'</td></tr>";
							}
						?>
					</tbody>
			</table>
